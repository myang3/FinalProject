...
namespace YelpAPI
{
    ...
    class YelpAPIClient
    {
        ...
        /// </summary>
        private const string CONSUMER_KEY = "ozEkC_4IOnCbMLFyrqRLKQ";

        /// <summary>
        /// Consumer secret used for OAuth authentication.
        /// This must be set by the user.
        /// </summary>
        private const string CONSUMER_SECRET = "xlRCZ5l_c6zjej0mpFerAvgoytA";
        ...
        /// This must be set by the user.
        /// </summary>
        private const string TOKEN_SECRET = "TPUxBCw5JoXgU2X37De6R1kAzOA";
